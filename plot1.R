# Plot 1 Code for Coursera Exploratory Data Analysis Course Project 1
...
hist(plotdataNEW$Global_active_power,col="red",main="Global Active Power",xlab="Global Active Power (kilowatts)")
